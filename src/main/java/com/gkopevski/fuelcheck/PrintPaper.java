        ...
        public int print(Graphics graphics, PageFormat pageFormat,
            ...
            if (pageIndex == 0) {
                ...
                try {
                     ...
                     */
                    int x = 40;                                        //print start at 100 on x axies
                    int y = 10;                                          //print start at 10 on y axies
                    int imagewidth = 100;
                    int imageheight = 50;
                    BufferedImage read = ImageIO.read(ClassLoader.getSystemResource("logo.png"));
                ...
                try {
                    /*Draw Header*/
                    int y = 100;
                    g2d.drawString("DETOIL", 65, y);
                    g2d.drawString("CopyWrite "+ Calendar.getInstance().get(Calendar.YEAR), 50, y + 10);                 //shift a line by adding 10 to y value
                    g2d.drawString(now(), 30, y + 20);                                //print date
...
//                    g2d.drawLine(10, y + 60, 180, y + 60);
                    ...
                    g2d.drawString("Natocil: ", 10, y + 50);
                    g2d.drawString(FuelCheckForm.latestFE.getDriver(), 50, y + 50);
                    
                    g2d.drawString("Kolicina: ", 10, y + 60);
                    g2d.drawString(""+FuelCheckForm.latestFE.getQuantity() 
                            + " " + FuelCheckForm.latestFE.getMeasurementUnit() 
                            + "   " + FuelCheckForm.latestFE.getProduct(), 50, y + 60);
